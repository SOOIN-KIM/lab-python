...
if __name__ == '__main__':
    ...
    with cx_Oracle.connect('scott', 'tiger', dsn) as connection:
        ...
        with connection.cursor() as cursor:
            ...
            emp_dept_left = pd.merge(emp_df,dept_df,on='DEPTNO',how='left')
            print(emp_dept_left)
            emp_dept_right = pd.merge(emp_df,dept_df,on='DEPTNO',how='right')
            print(emp_dept_right)

            # emp 테이블에서 mgr 과 empno가 일치하는 join *self 조인
