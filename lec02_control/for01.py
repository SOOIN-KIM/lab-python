...
literable(반복 가능한 타입): list, tuple, set, dictionary, str, ...
'''

# range(to) : 0 부터 (to -1)까지 범위의 숫자들
# range(from, to) from 부터 (to -1)까지 범위의 숫자들
# range(from, to, step): from 부터 (to -1)까지 step 만큼
...
# in dict는 dictionaty의 key들을 반복 한다.
